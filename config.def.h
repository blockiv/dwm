...
static const char *fonts[]          = { "OperatorMono Nerd Font:size=11" };
static const char dmenufont[]       = "OperatorMono Nerd Font:size=11";
...
const char *spcmd1[] = { "st", "-c", "Scratchpad", "-g", "120x34", NULL };
const char *spcmd2[] = { "st", "-c", "Pulsemixer", "-g", "144x41", "-e", "pulsemixer", NULL };
const char *spcmd3[] = { "st", "-c", "VIFM", "-g", "144x41", "-e", "vifm", NULL };
...
static const Rule rules[] = {
	...
	{ "Scratchpad", NULL,         NULL,           SPTAG(0),   1,          0,          0,          -1 },
	{ "Pulsemixer", NULL,         NULL,           SPTAG(1),   1,          0,          0,          -1 },
	{ "VIFM",       NULL,         NULL,           SPTAG(2),   1,          0,          0,          -1 },
